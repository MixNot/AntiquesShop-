        ...
        <div className="userShow">
          <div className="userShowTop">
            ...
            <div className="userShowTopTitle">
              <span className="userShowUsername">Анна Беккер</span>
              <span className="userShowUserTitle">Инженер-программист</span>
            </div>
          </div>
          <div className="userShowBottom">
            <span className="userShowTitle">Детали учетной записи</span>
            ...
            <span className="userShowTitle">Контактная информация</span>
            <div className="userShowInfo">
